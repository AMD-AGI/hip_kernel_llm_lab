...
#############################################
# Data & Model
TRAIN_FILE="./dataset/kernel-agent-single-sft-1125/rl_data_v01_mi325x_react_sample_json_v1_verl.parquet"
VAL_FILE="./dataset/kernel-agent-single-sft-1125/rl_data_v01_mi325x_react_sample_json_v1_verl.parquet"
MODEL_PATH="./models/kernel-agent-baseline-qwen3-8b-1202/sft-merged-101k-if-reasoning-dedup-mh-qwen3-14b"  

RES_LENGTH=24576      #bkup: 32576
...
# Rollout & Sampling
ROLLOUT_N=16              # 增加每个prompt的采样数 (4→8) 增加探索多样性
...
# export SF_URL="http://172.16.19.155:8080/run_code"
# export SF_URL="http://172.17.115.85:8080/run_code"
...
EXPERIMENT_NAME="14b-react-w-domain-knowledge-Exp01"
